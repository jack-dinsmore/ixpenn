...
if [ -z "${USE_MOM}" ]; then
    # NN
    ftcopy $DATA_FOLDER"$FILENAME"_recon_nn_stokes_w_adj_j2000.fits'[EVENTS][col TRG_ID; TIME; STATUS; STATUS2; PI; W_MOM; W_NN; X; Y; Q; U]' $FINAL_FOLDER/"$FINAL_FILENAME"_uncorr.fits clobber=True
